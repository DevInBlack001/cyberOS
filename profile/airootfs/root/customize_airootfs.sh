...
# Firewall: ufw is installed but deliberately NOT enabled. A default-deny
# inbound policy silently breaks the lab exercises this ISO exists for —
# Metasploit handlers, bind shells, local servers all listen. Students turn it
# on when the exercise is about firewalls:
